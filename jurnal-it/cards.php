        ...
        $query_total = "
            ...
            AND (
                EXISTS (
                    ...
                    AND th.approved IS NULL
                )
                OR EXISTS (
                    SELECT 1 FROM transaksi_catatan tc 
                    WHERE tc.user_id = u.id 
                    AND tc.approved IS NULL
                )
            )
        ";
...
<?php endif; ?>
    ...
    <?php
        ...
        $sql = "
           SELECT 
            ...
            AND DATE(input_datetime) = CURDATE()
        ";
    ...
    <div class= "row-section">
        <div class="card-stats card">
            <div class="card-header">Statistik Cepat (Hari Ini)<abbr style="font-size: 14px;"><?php echo $_SESSION['name']; ?></abbr></div>
